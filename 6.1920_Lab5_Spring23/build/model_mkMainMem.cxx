...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_bram_serverAdapter_s1_6_BIT_1___d51;
	 tUInt8 DEF_INST_top_DEF_bram_serverAdapter_outDataCore_notEmpty____d2;
	 tUInt8 DEF_INST_top_DEF_bram_serverAdapter_outDataCore_notFull____d49;
	 tUInt8 DEF_INST_top_DEF_bram_serverAdapter_outDataCore_i_notFull____d10;
	 tUInt8 DEF_INST_top_DEF_bram_serverAdapter_outDataCore_i_notEmpty____d1;
	 tUInt8 DEF_INST_top_DEF_bram_serverAdapter_outData_enqData_whas____d6;
	 tUInt8 DEF_INST_top_DEF_bram_serverAdapter_outData_deqCalled_whas____d11;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_setFirstCore;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_bram_serverAdapter_outData_setFirstCore;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_setFirstEnq;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_bram_serverAdapter_outData_setFirstEnq;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_enqOnly;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_bram_serverAdapter_outData_enqOnly;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_deqOnly;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_bram_serverAdapter_outData_deqOnly;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_enqAndDeq;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_bram_serverAdapter_outData_enqAndDeq;
	 ...
	 INST_top.DEF_bram_serverAdapter_s1___d46 = INST_top.INST_bram_serverAdapter_s1.METH_read();
	 DEF_INST_top_DEF_bram_serverAdapter_outDataCore_notFull____d49 = INST_top.INST_bram_serverAdapter_outDataCore.METH_notFull();
	 DEF_INST_top_DEF_bram_serverAdapter_s1_6_BIT_1___d51 = (tUInt8)((INST_top.DEF_bram_serverAdapter_s1___d46) >> 1u);
	 INST_top.DEF_bram_serverAdapter_s1_6_BIT_0___d47 = (tUInt8)((tUInt8)1u & (INST_top.DEF_bram_serverAdapter_s1___d46));
	 DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_moveToOutFIFO = (!(INST_top.DEF_bram_serverAdapter_s1_6_BIT_0___d47) || DEF_INST_top_DEF_bram_serverAdapter_outDataCore_notFull____d49) && DEF_INST_top_DEF_bram_serverAdapter_s1_6_BIT_1___d51;
	 ...
	 DEF_INST_top_DEF_bram_serverAdapter_outDataCore_i_notEmpty____d1 = INST_top.INST_bram_serverAdapter_outDataCore.METH_i_notEmpty();
	 DEF_INST_top_DEF_bram_serverAdapter_outDataCore_notEmpty____d2 = INST_top.INST_bram_serverAdapter_outDataCore.METH_notEmpty();
	 DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_setFirstCore = DEF_INST_top_DEF_bram_serverAdapter_outDataCore_i_notEmpty____d1 && DEF_INST_top_DEF_bram_serverAdapter_outDataCore_notEmpty____d2;
	 DEF_INST_top_DEF_WILL_FIRE_RL_bram_serverAdapter_outData_setFirstCore = DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_setFirstCore;
	 DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_overRun = DEF_INST_top_DEF_bram_serverAdapter_s1_6_BIT_1___d51 && !DEF_INST_top_DEF_bram_serverAdapter_outDataCore_notFull____d49;
	 ...
	 DEF_INST_top_DEF_bram_serverAdapter_outData_enqData_whas____d6 = INST_top.INST_bram_serverAdapter_outData_enqData.METH_whas();
	 DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_setFirstEnq = !DEF_INST_top_DEF_bram_serverAdapter_outDataCore_notEmpty____d2 && DEF_INST_top_DEF_bram_serverAdapter_outData_enqData_whas____d6;
	 DEF_INST_top_DEF_WILL_FIRE_RL_bram_serverAdapter_outData_setFirstEnq = DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_setFirstEnq;
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_bram_serverAdapter_outData_setFirstCore)
	   INST_top.RL_bram_serverAdapter_outData_setFirstCore();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_bram_serverAdapter_outData_setFirstEnq)
	   INST_top.RL_bram_serverAdapter_outData_setFirstEnq();
	 ...
	 INST_top.DEF_dl_d_0_rv_port1__read____d371 = INST_top.INST_dl_d_0_rv.METH_port1__read();
	 DEF_INST_top_DEF_CAN_FIRE_RL_deq = (DEF_INST_top_DEF_bram_serverAdapter_outDataCore_notEmpty____d2 || DEF_INST_top_DEF_bram_serverAdapter_outData_enqData_whas____d6) && (INST_top.INST_bram_serverAdapter_outData_outData.METH_whas() && !INST_top.DEF_dl_d_0_rv_port1__read____d371.get_bits_in_word8(16u,
																																						 0u,
																																						 1u));
	 DEF_INST_top_DEF_WILL_FIRE_RL_deq = DEF_INST_top_DEF_CAN_FIRE_RL_deq;
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_deq)
	   INST_top.RL_deq();
	 INST_top.DEF_bram_serverAdapter_cnt_3_whas____d24 = INST_top.INST_bram_serverAdapter_cnt_3.METH_whas();
	 INST_top.DEF_bram_serverAdapter_cnt_2_whas____d22 = INST_top.INST_bram_serverAdapter_cnt_2.METH_whas();
	 INST_top.DEF_bram_serverAdapter_cnt_1_whas____d21 = INST_top.INST_bram_serverAdapter_cnt_1.METH_whas();
	 DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_cnt_finalAdd = (INST_top.DEF_bram_serverAdapter_cnt_1_whas____d21 || INST_top.DEF_bram_serverAdapter_cnt_2_whas____d22) || INST_top.DEF_bram_serverAdapter_cnt_3_whas____d24;
	 ...
	 DEF_INST_top_DEF_bram_serverAdapter_outData_deqCalled_whas____d11 = INST_top.INST_bram_serverAdapter_outData_deqCalled.METH_whas();
	 DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_deqOnly = (DEF_INST_top_DEF_bram_serverAdapter_outDataCore_i_notEmpty____d1 && (DEF_INST_top_DEF_bram_serverAdapter_outData_deqCalled_whas____d11 && !DEF_INST_top_DEF_bram_serverAdapter_outData_enqData_whas____d6)) && !DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_setFirstEnq;
	 DEF_INST_top_DEF_WILL_FIRE_RL_bram_serverAdapter_outData_deqOnly = DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_deqOnly;
	 DEF_INST_top_DEF_bram_serverAdapter_outDataCore_i_notFull____d10 = INST_top.INST_bram_serverAdapter_outDataCore.METH_i_notFull();
	 DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_enqAndDeq = ((DEF_INST_top_DEF_bram_serverAdapter_outDataCore_i_notEmpty____d1 && DEF_INST_top_DEF_bram_serverAdapter_outDataCore_i_notFull____d10) && (DEF_INST_top_DEF_bram_serverAdapter_outData_deqCalled_whas____d11 && DEF_INST_top_DEF_bram_serverAdapter_outData_enqData_whas____d6)) && !(DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_overRun || DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_setFirstEnq);
	 DEF_INST_top_DEF_WILL_FIRE_RL_bram_serverAdapter_outData_enqAndDeq = DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_enqAndDeq;
	 DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_enqOnly = (DEF_INST_top_DEF_bram_serverAdapter_outDataCore_i_notFull____d10 && (!DEF_INST_top_DEF_bram_serverAdapter_outData_deqCalled_whas____d11 && DEF_INST_top_DEF_bram_serverAdapter_outData_enqData_whas____d6)) && !DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_overRun;
	 DEF_INST_top_DEF_WILL_FIRE_RL_bram_serverAdapter_outData_enqOnly = DEF_INST_top_DEF_CAN_FIRE_RL_bram_serverAdapter_outData_enqOnly;
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_bram_serverAdapter_cnt_finalAdd)
	   INST_top.RL_bram_serverAdapter_cnt_finalAdd();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_bram_serverAdapter_outData_deqOnly)
	   INST_top.RL_bram_serverAdapter_outData_deqOnly();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_bram_serverAdapter_outData_enqAndDeq)
	   INST_top.RL_bram_serverAdapter_outData_enqAndDeq();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_bram_serverAdapter_outData_enqOnly)
	   INST_top.RL_bram_serverAdapter_outData_enqOnly();
	 ...
	 INST_top.INST_bram_serverAdapter_outData_deqCalled.clk((tUInt8)1u, (tUInt8)1u);
	 INST_top.INST_bram_serverAdapter_outData_outData.clk((tUInt8)1u, (tUInt8)1u);
	 INST_top.INST_bram_serverAdapter_outData_enqData.clk((tUInt8)1u, (tUInt8)1u);
	 INST_top.INST_bram_memory.clk((tUInt8)1u, (tUInt8)1u);
	 if (do_reset_ticks(simHdl))
	 {
	   INST_top.INST_bram_serverAdapter_outDataCore.rst_tick_clk((tUInt8)1u);
...
void MODEL_mkMainMem::create_model(tSimStateHdl simHdl, bool master)
{
  ...
  (mkMainMem_instance->INST_bram_serverAdapter_outDataCore.set_clk_0)("CLK");
  (mkMainMem_instance->INST_bram_serverAdapter_outData_enqData.set_clk_0)("CLK");
  (mkMainMem_instance->INST_bram_serverAdapter_outData_outData.set_clk_0)("CLK");
  (mkMainMem_instance->INST_bram_serverAdapter_outData_deqCalled.set_clk_0)("CLK");
...
time_t MODEL_mkMainMem::get_creation_time()
{
  ...
  /* Thu Mar 23 02:14:28 UTC 2023 */
  return 1679537668llu;
}
