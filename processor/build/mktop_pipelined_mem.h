...
/* Generation options: */
#ifndef __mktop_pipelined_mem_h__
#define __mktop_pipelined_mem_h__
...
/* Class declaration for the mktop_pipelined_mem module */
class MOD_mktop_pipelined_mem : public Module {
 ...
 /* Constructor */
 public:
  MOD_mktop_pipelined_mem(tSimStateHdl simHdl, char const *name, Module *parent);
 ...
 public:
  ...
  void dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mktop_pipelined_mem &backing);
  void vcd_defs(tVCDDumpType dt, MOD_mktop_pipelined_mem &backing);
  void vcd_prims(tVCDDumpType dt, MOD_mktop_pipelined_mem &backing);
  void vcd_submodules(tVCDDumpType dt, unsigned int levels, MOD_mktop_pipelined_mem &backing);
};

#endif /* ifndef __mktop_pipelined_mem_h__ */
